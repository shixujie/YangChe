...
public class InterFace_011 implements Serializable{
	 ...
	 * @param bid_id
	 */
	public InterFace_011(Integer mc_id,String mc_name, double latitude, double longitude,double star,double price,Integer bid_id) {
		this.mc_id = mc_id;
